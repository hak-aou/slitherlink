...
def dessine_segmentInterdit(etat):
    ...
    for seg in etat:
        if etat[seg] == -1:
            ...
            fltk.image(x, y, "img/croix.png", tag='Interdit')
...
def menu_debutJeu(xFleche, yFleche):
    ...
    while True:
        fltk.efface("fleche")
        fltk.image(250, 250, "img/fondmenu.png")
        fltk.image(xFleche, yFleche, "img/fleche.png", tag='fleche')
...
def menu_choixGrille(xFleche, yFleche, listeGrille, NomGrille):
    ...
    while True:
        ...
        fltk.image(250, 250, "img/touches.png")
        fltk.image(xFleche, yFleche, "img/fleche.png", tag='fleche')

        nomfile = "grilles/" + listeGrille[poseFleche]
        ...
        if ty == "Touche":
            if fltk.touche(ev) == "Up":
                ...
                fltk.efface_tout()
                return "grilles/" + listeGrille[poseFleche]
